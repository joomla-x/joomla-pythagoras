...
abstract class Jquery
{
	...
	public static function framework($noConflict = true, $debug = null, $migrate = true)
	{
		...
		Html::_('script', 'jui/jquery.min.js', false, true, false, false, $debug);

		// Check if we are loading in noConflict
		if ($noConflict)
		{
			Html::_('script', 'jui/jquery-noconflict.js', false, true, false, false, false);
		}

		// Check if we are loading Migrate
		if ($migrate)
		{
			Html::_('script', 'jui/jquery-migrate.min.js', false, true, false, false, $debug);
		}
	...
	public static function ui(array $components = array('core'), $debug = null)
	{
		...
		foreach ($components as $component)
		{
			...
			{
				Html::_('script', 'jui/jquery.ui.' . $component . '.min.js', false, true, false, false, $debug);
