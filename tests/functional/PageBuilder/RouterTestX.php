...
class RouterTest extends DatabaseTestCase
{
    ...
    {
        $repository = (new RepositoryQueryHandler(new CommandBus([]),
            new Dispatcher))->handle(new RepositoryQuery('page'));
            ...
            [
                ...
                'master_content' => [
                    [
                        ...
                        'master_id' => 1,
                        'position'  => '',
                        // The position, similar to J!3's module position
                        'ordering'  => 1,
                        // Order of this element within this position
                        'component' => 'content',
                        // Component to provide the content
                        'layout'    => 'default',
                        // The layout for the content
                        'reference' => null,
                        // If related to another content item on this page, this is a pointer to it (format position:ordering)
                        'selection' => 'id=1',
                        // The selection criteria. Related content item is addressed as 'ref'
                        'params'    => '{}'
                ...
                'pages'          => [
                    [
                        'id'        => 23,
                        'url'       => 'path/to/article',
                        // The URL for this page. May contain variables, denoted with leading colon
                        'title'     => 'An Article',
                        // The label for the menu item
                        'parent_id' => null,
                        // Parent menu item
                        'master_id' => 1
                        // Master to use as a base for this page
                    ],
                    [
                        'id'        => 42,
                        'url'       => 'a/different/url',
