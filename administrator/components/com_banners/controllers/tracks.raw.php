...
class BannersControllerTracks extends JControllerLegacy
{
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		if ($view = $this->getView($vName, $vFormat))
		{
			...
			setcookie(Helper::getHash($this->context . '.basename'), $form['basename'], time() + 365 * 86400, $cookie_path, $cookie_domain);
			setcookie(Helper::getHash($this->context . '.compressed'), $form['compressed'], time() + 365 * 86400, $cookie_path, $cookie_domain);
